...
$mail = new Email();
//参数2,3 自行替换为自己的
$mail->setServer("smtp.exmail.qq.com", "Mail@address.com", "Passwd", 465, true); 	//到服务器的SSL连接
//如果不需要到服务器的SSL连接，这样设置服务器：$mail->setServer("smtp.126.com", "XXX@126.com", "XXX");
$mail->setFrom("nicedata@oneniceapp.com");
$mail->setReceiver("850391612@qq.com");
...
$mail->setMail("testUrl", "<a href='http://www.oneniceapp.com/marketmis/product/audit'>Mis审核平台</a>");
$mail->sendMail();
